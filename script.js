...
var height = [4, 8, 6, 8, 3.5, 4, 2.5, 19, 4, 20, 12, 11, 4, 19];
var width = [4, 8, 7, 8, 3.5, 5, 2.5, 19, 11, 18, 13, 12, 11, 19];
...
function openMenu(menu) {
  ...
  planes[13].setAttribute("height",height[13]);
  planes[13].setAttribute("width",width[13]);
